...
Files are be uploaded by the user, having an option of working from an existing clustering (having an additional upload box) and skipping the initial clustering stage. Results can be downloaded at the end of the run by clicking the "Download data as CSV" button.

![GUI Existing Clustering Upload Box. \label{fig:ExistingClustering}](./imgs/ExistingClustering.png)
